...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                setTimeout(function () {
                  ...
                  query.exec(function (res) {
                    _this5.tonggaoSwiperHeight = res[0].height;
                  });
                }, 100);
                _context4.next = 10;
                break;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                _this7.inviteAdviseList({
                  city_filter: _this7.recommend_city_filter
                }); // 通告推荐


                _this7.noticeAdviseList({
                  city_filter: _this7.recommend_city_filter
                });
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 26:
                ...
                if (_context12.t0.data.error_code == 10100 && _this11.pageNum > 1) {
                  _this11.noMore = true;
                }
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 26:
                ...
                if (_context13.t0.data.error_code == 11020) {
                  _this12.visible = true;
                  _this12.isclick = false;
                  console.log(_context13.t0, "error");
                }

                if (_context13.t0.data.error_code == 10100 && _this12.pageNum > 1) {
                  _this12.noMore = true;
                }
    ...
    shareInviteInfo: function (_shareInviteInfo) {
      function shareInviteInfo(_x) {
        return _shareInviteInfo.apply(this, arguments);
      }

      shareInviteInfo.toString = function () {
        return _shareInviteInfo.toString();
      };
  ...
  onPageScroll: function onPageScroll(e) {
    ...
    if (!this.isclick) {
      ...
      query.select(".componets").boundingClientRect(function (rect) {
        ...
        if (top <= 50) {
          _this15.navShow = true;
          _this15.autoplay = false;
        } else {
          _this15.navShow = false;
          _this15.autoplay = true;
        }
      }).exec();
    }
  },
  ...
  created: function created() {
    this.globalData = this.globalData; // 消息通知红点

    this.notifyNumber(""); // 当前城市&是否签到

    this.userStatus("");
    this.inviteFilter({}); // 分享
