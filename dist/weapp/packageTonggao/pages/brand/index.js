  ...
  methods: {
    ...
    minFansInput: function minFansInput(e) {
      ...
      if (!exp.test(e.detail.value)) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_5__[/* errortip */ "a"])("请输入纯数字！");
        this.minFans = "";
      }
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index_js__WEBPACK_IMPORTED_MODULE_4__[/* publicConfig */ "Nb"])(params);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index_js__WEBPACK_IMPORTED_MODULE_4__[/* submitNotice */ "rc"])(params);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return Object(_api_index_js__WEBPACK_IMPORTED_MODULE_4__[/* noticePayment */ "yb"])(params);

              case 3:
                res = _context3.sent;
                Object(_utils_util__WEBPACK_IMPORTED_MODULE_5__[/* openPage */ "d"])("/packageAdd/pages/tips/index?type=1&msg=".concat(res.data.data));
                _context3.next = 9;
                break;
              ...
              _c(
                ...
                [
                  _vm.platform
                    ...
                    : _c(
                        "view",
                        { staticClass: "brand-select-item input-placeholder" },
                        [_vm._v("请选择")]
                      ),
                ]
              ),
