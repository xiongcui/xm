...
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.scss */ "./src/packageTonggao/pages/tonggao_manage/index.scss");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    deleteTonggao: function deleteTonggao(oid) {
      var _this = this;
    ...
    openTonggao: function openTonggao(oid) {
      Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageTonggao/pages/open_recruitment/index?oid=" + oid);
    },
    ...
    refreshTonggao: function refreshTonggao(oid) {
      var _this = this;
    ...
    manageTonggao: function manageTonggao(oid) {
      Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageMsg/pages/manageSignup/index?oid=" + oid);
    },
    ...
    manageList: function manageList(params) {
      var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* manageList */ "fb"])(params);
    ...
    manageOperation: function manageOperation(params) {
      var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* manageOperation */ "gb"])(params);
                    ...
                    _vm.list.length
                      ? _c(
                          ...
                          _vm._l(_vm.list, function (item, index) {
                            return _c(
                              "view",
                              { key: index, staticClass: "componets-box" },
                              [
                                _c(
                                  "view",
                                ...
                                _c("view", { staticClass: "list_bottom" }, [
                                  ...
                                  _c("view", { staticClass: "list_bt_rt" }, [
                                    ...
                                    _c("view", { staticClass: "list_tips" }, [
                                      ...
                                      _vm._v(
                                        " " +
                                          _vm._s(item.audit.audit_reason) +
                                          " "
                                      ),
                                    ]),
                                  ]),
...
var config = {"navigationBarTitleText":"通告管理"};
