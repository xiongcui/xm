...
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.scss */ "./src/packageAdd/pages/zuopin/add_zuopin/index.scss");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      if (!this.name) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_3__[/* errortip */ "a"])("请填写作品名称！");
        return false;
      }

      if (!this.desc) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_3__[/* errortip */ "a"])("请填写作品背后的故事！");
        return false;
      }
      ...
      if (!checkTag) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_3__[/* errortip */ "a"])("请选择主题标签！");
        return false;
      }
      ...
      if (!checkTag2) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_3__[/* errortip */ "a"])("请选择作品标签！");
        return false;
      }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_4__[/* publicConfig */ "Lb"])(params);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_4__[/* subNotePhoto */ "kc"])(params);
