  ...
  methods: {
    ...
    goChooseMedia: function goChooseMedia() {
      if (this.platform_code) {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageAdd/pages/user/addfans/index?platform_code=" + this.platform_code + "&platform_name=" + this.platform_name);
      } else {
        Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageAdd/pages/user/platform/index");
      }
    },
          ...
          switch (res.tapIndex) {
            case 0:
              if (_this.platform_code) {
                Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageAdd/pages/user/addfans/index?platform_code=" + _this.platform_code + "&platform_name=" + _this.platform_name + "&oid=" + oid);
              } else {
                Object(_utils_util__WEBPACK_IMPORTED_MODULE_4__[/* openPage */ "d"])("/packageAdd/pages/user/addfans/index?platform_code=" + platform_code + "&platform_name=" + platform_name + "&oid=" + oid);
              }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* celebrityList */ "q"])(params);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* userCelebrity */ "Dc"])(params);
