...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    goChooseMedia: function goChooseMedia(row) {
      Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__[/* openPage */ "b"])("/packageAdd/pages/user/addfans/index?platform_code=" + row.platform_code + "&platform_name=" + row.platform_name);
    }
  }
});
