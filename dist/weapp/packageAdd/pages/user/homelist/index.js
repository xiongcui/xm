          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* inviteList */ "H"])(params);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* noticeList */ "Y"])(params);
              ...
              case 3:
                ...
                _this2.noticeList = res.data.data.items;
                _this2.loading = true;
                _context2.next = 22;
                break;
              ...
              case 19:
                data = res.data.data.items;
                _this2.noticeList = _this2.noticeList.concat(data);
                _this2.loading = true;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* photoList */ "gb"])(params);
              ...
              case 3:
                ...
                _this3.zuopinList = res.data.data.items;
                _this3.loading = true;
                _context3.next = 22;
                break;
              ...
              case 19:
                data = res.data.data.items;
                _this3.zuopinList = _this3.zuopinList.concat(data);
                _this3.loading = true;
              ...
              case 26:
                ...
                if (_context3.t0.data.error_code == 10100 && _this3.pageNum > 1) {
                  _this3.noMore = true;
                }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* inviteFilter */ "E"])(params);
              ...
              case 3:
                ...
                if (res.data.data.quick_filter) {
                  _this4.navList = res.data.data.quick_filter;
                }
                ...
                _this4.appointmentData = arr;
                _this4.chargeData = arr2;
                _this4.purposeData = arr3;
                _this4.select_filter = {
                  sex: 10,
                  payment_type: 0
                };

                _this4.query("init", _this4.$refs["pageNavRef"].navActive, scroll);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* noticeFilter */ "W"])(params);
              ...
              case 3:
                ...
                if (data.quick_filter) {
                  _this5.navList = data.quick_filter;
                }
                ...
                _this5.identityData = arr;
                _this5.noticeData = arr1;
                ...
                _this5.noticeQuery("init", _this5.$refs["pageNavRef"].navActive, scroll);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.prev = 0;
                _context6.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_8__[/* photoFilter */ "eb"])(params);
              ...
              case 3:
                ...
                _this6.identityData = arr3;
                _this6.select_filter = {
                  author_career: 0,
                  author_sex: 10
                };

                _this6.zuopinQuery("init", _this6.$refs["pageNavRef"].navActive, scroll);
...
var config = {"navigationBarTitleText":"虾米约拍","enablePullDownRefresh":true};
