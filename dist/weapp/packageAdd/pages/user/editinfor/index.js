    ...
    chooseImage: function chooseImage() {
      wx.chooseMedia({
        ...
        success: function success(res) {
          ...
          Object(_utils_util__WEBPACK_IMPORTED_MODULE_2__[/* openPage */ "b"])("/packageAdd/pages/user/we-cropper/index?imgSrc=" + path + "&type=avatar");
        }
      });
    },
    sub: function sub() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* profileUpdate */ "Q"])(params);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* updateAvatar */ "ib"])(params);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_3__[/* userProfile */ "pb"])(params);
