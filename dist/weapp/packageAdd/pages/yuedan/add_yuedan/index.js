...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_4__[/* creatInvite */ "D"])(params);
              ...
              case 3:
                ...
                wx.showModal({
                  title: "温馨提示",
                  content: "\u53D1\u5E03\u7EA6\u62CD\u4FE1\u606F\u6D88\u8017".concat(data.coin, "\u4E2A\u91D1\u8C46\uFF0C\u786E\u5B9A\u53D1\u5E03\u5417\uFF1F"),
                  success: function success(res) {
                    if (res.confirm) {
                      console.log("用户点击确定");
    ...
    invitePayment: function invitePayment(params) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return Object(_api_index__WEBPACK_IMPORTED_MODULE_4__[/* invitePayment */ "Z"])(params);
